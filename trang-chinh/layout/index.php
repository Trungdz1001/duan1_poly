            ...
            <div class="boxtrai mr">
                ...
                <div class="row">
                    <div class="sanpham mr">
                        <div class=" row img"><a href="sp1.php"><img src="IMG/4.jpg" alt=""></a></div>
                        <p>$120</p>
                        <a href="sp1.php">Jordan 1 Retro High OG Chicago</a>
                    </div>
                    <div class="sanpham mr">
                        <div class=" row img"><a href="sp2.php"><img src="IMG/5.png" alt=""></a></div>
                        <p>$150</p>
                        <a href="sp2.php">Jordan 1 Retro ‘Hyper Royal’</a>
                    </div>
                    <div class="sanpham">
                        <div class=" row img"><a href="sp3.php"><img src="IMG/6-1.jpg" alt=""></a></div>
                        <p>$100</p>
                        <a href="sp3.php">Jordan 1 Royal Blue</a>
                    </div>
                    <div class="sanpham mr">
                        <div class=" row img"><a href="sp4.php"><img src="IMG/7.jpg" alt=""></a></div>
                        <p>$10000</p>
                        <a href="sp4.php">Jordan 1 Dior Low</a>
                    </div>
                    <div class="sanpham mr">
                    ...
                    <div class="sanpham mr">
                        <div class=" row img"><img src="IMG/10.jpg" alt=""></div>
                        <p>$100</p>
                        <a href="#">Áo thun Nike Jordans "Jump man"</a>
                    </div>
                    <div class="sanpham mr">
                        <div class=" row img"><img src="IMG/11.jfif" alt=""></div>
                        <p>$100</p>
                        <a href="#">Áo thun SUPREME "Dragonball-BAPE" </a>
                    </div>
                    <div class="sanpham">
                        <div class=" row img"><img src="IMG/12.png" alt=""></div>
                        <p>$20</p>
                        <a href="#">Áo thun Adidas Basic</a>
                    </div>
                ...
                <div class="row mb">
                    ...
                    <div class="boxcontent2 menudoc">
                        <ul>
                            ...
                            <li>
                                <a href="atA.php">Áo thun Adidas</a>
                            </li>
                            <li>
                ...
                <div class="row">
                    ...
                    <div class="boxcontent row">
                        <div class="row mb10 top10">
                            ...
                            <a href="YT1.php">Giày Jordan 1 Red</a>
                        </div>
                        <div class="row mb10 top10">
                            <img src="IMG/7.jpg" alt="">
                            <a href="YT2.php">Giày Jordan 1 DIOR</a>
                        </div>
                        <div class="row mb10 top10">
                            <img src="IMG/8.png" alt="">
                            <a href="YT3.php">Giày Air Forced 1 Shadow</a>
                        </div>
                        <div class="row mb10 top10">
                            <img src="IMG/10.jpg" alt="">
                            <a href="YT4.php">Áo thun Jordans "Jump man"</a>
                        </div>
                        <div class="row mb10 top10">
                            <img src="IMG/9.png" alt="">
                            <a href="YT5.php">Giày Air Forced 1 Blue white </a>
                        </div>
                    </div>
                </div>
            </div>
