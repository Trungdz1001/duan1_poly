<?php
    ...
    if(isset($_POST['btn-edit'])){
      if($_POST['id_dm_sp']=="" or $_POST['tieu_de']=="" or $_POST['noi_dung']=="" or $_POST['img_id']==""){
        ...
        $img_id=$_POST['img_id'];
        danhmuc_update($id_dm_sp,$tieu_de,$noi_dung,$img_id);
    ...
    if(isset($_GET['id_dm_sp'])){
        ...
        $id_dm_sp_info=danhmuc_getinfo($id_dm_sp);
        extract($id_dm_sp_info);
        ...
        <h2>DANH MỤC</h2>
            ...
            <div class="row">
                <div class="form-group col-sm-6">
                    ...
                    <input type="text" name="id_dm_sp" class="form-control" value="<?php echo $id_dm_sp?>" style="border: none;">
                </div>
                <div class="form-group col-sm-6">
                    <h4>Tiêu đề</h4>
                    <input type="text" name="tieu_de" class="form-control" value="<?php echo $tieu_de?>">
                </div>
                <div class="form-group col-sm-6">
                  <h4>Hình ảnh</h4>
                ...
                <div class="form-group col-sm-6">
                    <h4>Nội dung</h4>
                    <input type="text" name="noi_dung" class="form-control" value="<?php echo $noi_dung?>">
                </div>
